            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex flex-col md:flex-row items-center">
                        <div class="p-4">
                            <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="rounded-lg w-full">
                        </div>
                        ...
                        <div class="md:w-1/2 md:pl-8 mt-4 md:mt-0">
                            ...
                            <p class="text-gray-900 text-xl font-semibold mt-4">Price: IDR.{{ number_format($product->price, 2) }}</p>
                            ...
                            <div class="mt-6">
                                ...
                                <input type="number" id="quantity" name="quantity" value="1" min="1" class="w-20 px-2 py-1 border rounded-md" required>
                            </div>
